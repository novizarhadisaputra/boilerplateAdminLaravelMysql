        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ request()->is('master-data/*')  ?'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is('master-data/safety-patrol-categories') || request()->is('master-data/safety-patrol-categories/*') ? 'active' : '' }}"><a class="nav-link" href={{ route('safety-patrol-categories.index') }}>Safety Patrol Categories</a></li>
                </ul>
            </li>
            @endcan
