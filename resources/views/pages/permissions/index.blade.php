                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('permissions.destroy', $item->id) }}" data-toggle="tooltip" title=""
                                    ...
                                    <form id="delete-{{ $loop->iteration }}" action="{{ route('permissions.destroy', $item->id) }}" method="POST" class="d-none">
                                        @csrf
                                        @method('DELETE');
                                    </form>
                                </td>
