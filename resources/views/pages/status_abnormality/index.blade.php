                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('status-abnormality.destroy', $item->id) }}" data-toggle="tooltip" title=""
                                    ...
                                    <form id="delete-{{ $loop->iteration }}" action="{{ route('status-abnormality.destroy', $item->id) }}" method="POST" class="d-none">
                                        @csrf
                                        @method('DELETE');
                                    </form>
                                </td>
